...
import MerchantScanNFTScreen from "./pages/merchantScanNFT";
import NumberVerificationScreen from "./pages/numberVerification";
import SplashSuccessScreen from "./pages/splashSuccess";
import MoreAboutYouScreen from "./pages/moreAboutYou";
import OnRampScreen from "./pages/onRampScreen";
...
const ROUTES = [
  ...
  { name: 'MoreAboutYou', component: MoreAboutYouScreen },

  { name: 'SplashSuccess', component: SplashSuccessScreen },
  { name: 'NumberVerification', component: NumberVerificationScreen },
  ...
  { name: 'MerchantScan', component: MerchantScanNFTScreen },
  { name: 'Market', component: MarketPage },
  { name: 'Onramp', component: OnRampScreen },
