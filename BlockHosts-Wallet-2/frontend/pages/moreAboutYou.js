  ...
  return (
    <ScrollView style={styles.root}>
      ...
      <View style={styles.viewContainer}>
        <Text style={{ color: '#000', fontSize: 25, fontWeight: '700' }}>{'Preferences'}</Text>
      ...
      <View style={{ marginHorizontal: 16 }}>
        ...
        <View style={{ justifyContent: 'center', }}>
          ...
          <TouchableOpacity
            style={[styles.button, { backgroundColor: !isAvailable ? 'rgba(175, 236, 214, 0.8)' : '#f9699a', marginTop: 40 }]}
