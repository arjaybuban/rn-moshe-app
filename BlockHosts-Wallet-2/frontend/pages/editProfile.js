    ...
    <ScrollView style={styles.root}>
      ...
      <View style={{ marginHorizontal: 30, marginVertical: 20 }}>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          <View style={[styles.button, !title && styles.error]}>
          ...
          <View>
            ...
            {loaded ? <PhoneInput
              ...
              layout="first"
              containerStyle={[styles.button, !number && styles.error]}
          ...
          <View style={[styles.button, !email && styles.error]}>
            <TextInput style={{ color: '#000', fontSize: 16 }}
              placeholder={'Email'}
              placeholderTextColor={'#92959d'}
              value={email}
          ...
          <TouchableOpacity
            style={[styles.button, { backgroundColor: !isEnabledSave ? 'rgba(175, 236, 214, 0.8)' : '#f9699a' }]}
